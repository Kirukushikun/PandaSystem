...
- Two admin-adjacent routes (`/hrapprover/employeerecord-view`, `/approver/employeerecord-view`) are gated with `module.access:HRP` instead of the module you'd expect from their path.
